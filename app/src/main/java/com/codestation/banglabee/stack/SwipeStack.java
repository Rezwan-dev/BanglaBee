...
package com.codestation.banglabee.stack;
...
import com.codestation.banglabee.R;
...
public class SwipeStack extends ViewGroup {
    ...
    public static final float DEFAULT_SWIPE_OPACITY = 0.2f;
    ...
    private void reorderItems() {
        for (int x = 0; x < getChildCount(); x++) {
            ...
            childView.layout(
                        newPositionX,
                    (int) (getPaddingTop()+(x*mViewSpacing)),
                    (int) (newPositionX + childView.getMeasuredWidth()-x*mViewSpacing/4),
                        getPaddingBottom() + childView.getMeasuredHeight());
